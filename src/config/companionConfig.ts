...
export const companionDialogue = {
  ...
  wake: [
    "Hello, {name}. Let us get things done.",
    "Yay, {name}. You are back. My ears perked right up.",
    "I missed you, {name}. Let us find buddies.",
    "Oh, hello {name}. Back to work?",
    "There you are. Let us coordinate plans.",
    ...
    "I saved a very big amount of affection for your return.",
  ...
  pet: [
    ...
    "That pat switched my tiny purr engine on.",
...
export const companionRandomActions: CompanionAction[] = [
  ...
  { text: "Tucking into a cozy little cuddle pose.", pose: "snuggle", mood: "happy", accessory: "none", speechChance: 0.08 },
  ...
  { text: "Tiny paws tucked in. I am supervising from a cozy angle.", pose: "rest", mood: "happy", accessory: "none", speechChance: 0.07 },
  ...
  { text: "Counting tiny stars over the campus.", pose: "rest", mood: "happy", accessory: "moon", minPetCount: 200, speechChance: 0.08 },
  {
